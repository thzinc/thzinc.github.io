...
![Technical drawing of top plate with a 16-inch hole for the fan and markings for screw placement](/assets/workshop-air-filter/design-top.png){:.invertible}

![Technical drawing of the sides showing the arrangement of the 2x4 blocks and markings for screw placement](/assets/workshop-air-filter/design-sides.png){:.invertible}

![Technical drawing of multiple views of the assembly with indications of the four unique lengths of 2x4 blocks needed](/assets/workshop-air-filter/design-cuts.png){:.invertible}
