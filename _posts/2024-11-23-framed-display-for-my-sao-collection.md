...
final:
  ...
  - "@context": http://www.w3.org/ns/anno.jsonld
    ...
    body:
      - type: TextualBody
        value: |-
          2024 Solar Eclipse SAO v0.1 by Ben von Handorf (AB4EN)
  ...
  - "@context": http://www.w3.org/ns/anno.jsonld
    ...
    body:
      - type: TextualBody
        value: |-
          Persistence of Vision POV Display SAO by Michael Yim
  ...
  - "@context": http://www.w3.org/ns/anno.jsonld
    ...
    body:
      - type: TextualBody
        value: |-
          Surface mount soldering challenge SAO
  ...
  - "@context": http://www.w3.org/ns/anno.jsonld
    ...
    body:
      - type: TextualBody
        value: |-
          duckJAWS v0.2 by Adrian Studer
